...
-->
  ...
  <body>
    ...
    <ul class="breadcrumb">
      ...
      <li id="item_title_">متاجر ومخابز ثمار</li>
    </ul>
              ...
              <div class="row">
                <div class="col-md-5">
                  <div class="left-image">
                    <img src="assets/images/112.jpg" alt="" style="height: 400px; width: 400px;">
                  </div>
                </div>
                <div class="col-md-6 align-self-center">
                  <div class="right-content">
                    <h2 style="text-align: right;">متاجر ومخابز<em> ثمار</em></h2>
                    <p>
                    <h4 style="text-align: right;">تقـع متاجـر ومخابـز ثمـار في نفـس المجمـع الاسـتثماري للجمعيـة التعاونيـة على امتـداد شـارع الملـك فيصـل في وسـط المدينـة</h4>
                    </p>
                  </div>
                </div>
              </div>
