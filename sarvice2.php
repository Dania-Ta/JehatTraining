...
<html lang="en" dir="rtl">
  ...
  <head>
    ...
    <title>استطلاع رضا أعضاء مجلس الإدارة</title>
  ...
  <body>
    ...
    <div class="page-heading header-text">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h1>استطلاع رضا أعضاء مجلس الإدارة</h1>
          </div>
        </div>
      </div>
    </div>
...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-xl-7">
  <a href="https://bersystem.app//froms?page_id=173946" class="filled-button" target="_blank">هنا</a>
  </div>
  </div>
  <br>
  <br>
