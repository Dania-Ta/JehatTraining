  ...
  <body>
    ...
    <div class="page-heading header-text">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h1>المغاسل التعاونيةالاوتوماتيكيـة</h1>
          </div>
        </div>
      </div>
    </div>
    ...
    <ul class="breadcrumb">
      ...
      <li id="item_title_">المغاسل التعاونيةالاوتوماتيكيـة</li>
    </ul>
              ...
              <div class="row">
                <div class="col-md-5">
                  <div class="left-image">
                    <img src="assets/images/113.jpg" alt="" style="height: 400px; width: 400px;">
                  </div>
                </div>
                <div class="col-md-6 align-self-center">
                  <div class="right-content">
                    <h2 style="text-align: right;">المغاسل التعاونية <em> الأوتوماتيكية</em></h2>
                    <p>
                    <h4 style="text-align: right;">وحرصــا مــن الجمعيــة على تقديــم أفضل الخدمــات لقصــر رهــوان للشــقق الفندقيــة فقــد أعــدت المغاسـل التعاونيـة الاوتوماتيكيـة لتخـدم عمـلاء قصـر رهـوان والعمـلاء في المدينـة بشـكل عـام
                      <br>
                      وحرصــا مــن الجمعيــة على تقديــم أفضل الخدمــات لقصــر رهــوان للشــقق الفندقيــة فقــد أعــدت المغاسـل التعاونيـة الاوتوماتيكيـة لتخـدم عمـلاء قصـر رهـوان والعمـلاء في المدينـة بشـكل عـام</h4>
                    </p>
                  </div>
                </div>
              </div>
