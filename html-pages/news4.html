...
-->
  ...
  <body>
    ...
    <div class="page-heading header-text">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h1>الأخبار</h1>
            <span>زيارة جمعية تعاونية الرضا</span>
          </div>
        </div>
      </div>
    </div>
    ...
    <ul class="breadcrumb">
      ...
      <li id="item_title_">زيارة جمعية تعاونية الرضا</li>
    </ul>
              ...
              <div class="row">
                <div class="col-md-5">
                  <div class="left-image">
                    <img src="assets/images/11140.jpg" alt="" style="height: 400px; width: 400px;">
                  </div>
                </div>
                <div class="col-md-6 align-self-center">
                  <div class="right-content">
                    <h2 style="text-align: right;">زيارة جمعية<em>  تعاونية الرضا</em></h2>
                    <p> <h1 style="text-align: right;">16/06/1442</h1>
                      <br><br>
                    <h4 style="text-align: right;">سعدنا بزيارة جمعية تعاونية الرضا لتفعيل برنامج تبادل الخبرات بين الجمعيات نسأل الله لهم التوفيق والسداد وللجميع.</h4>
                    </p>
                  </div>
                </div>
              </div>
