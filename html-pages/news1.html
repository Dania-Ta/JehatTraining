...
-->
  ...
  <body>
    ...
    <div class="page-heading header-text">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h1>الأخبار</h1>
            <span>نتائج تقييم الحوكمة 2022.م</span>
          </div>
        </div>
      </div>
    </div>
    ...
    <ul class="breadcrumb">
      ...
      <li id="item_title_">نتائج تقييم الحوكمة 2022.م</li>
    </ul>
              ...
              <div class="row">
                <div class="col-md-5">
                  <div class="left-image">
                    <img src="assets/images/11110.jpg" alt="" style="height: 400px; width: 400px;">
                  </div>
                </div>
                <div class="col-md-6 align-self-center">
                  <div class="right-content">
                    <h2 style="text-align: right;">نتائج تقييم الحوكمة<em> 2022.م</em></h2>
                    <p>
                    <h4 style="text-align: right;">قام ممثل فريق تقييم الحوكمة أ. ايمن سعيد الغامدي بزيارة مقر الجمعية يوم الاثنين الموافق 20/2/2023م بحضور الممثل المالي أ.محمد الفرحان والمدير التنفيذي أ. وليد بن صالح الغامدي والمحاسب أ. باسم عاطف وتم مراجعة اعمال الجمعية ومطابقتها لنظام الحوكمة من قبل ممثل الوزارة والله ولي التوفيق.
                      <br><br>
                      التاريخ:</h4>
                    </p>
                  </div>
