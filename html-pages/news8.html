    ...
    <div class="page-heading header-text">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h1>الأخبار</h1>
            <span>أعرب رئيس مجلس ادارة جمعية الرهوة التعاونية الشيخ احمد الكلي عند شكره وامتنانه</span>
          </div>
        </div>
      </div>
    </div>

    <h2 id="item_department" style="color: #a4c639; font-size: 40px; padding-bottom: 40px; padding-right: 20px;">أخبار الجمعية</h2>
    <!-- Breadcrumbs -->
    <ul class="breadcrumb">
      <li><a href="index.html" style="color: #a4c639;"><i class="pe-7s-home"></i>
          الرئيسية</a></li>
      <li><a href="news.html" style="color: #a4c639;">أخبار الجمعية</a></li>
      <li id="item_title_">أعرب رئيس مجلس ادارة جمعية الرهوة التعاونية الشيخ احمد الكلي عند شكره وامتنانه</li>
    </ul>
              ...
              <div class="row">
                <div class="col-md-5">
                  <div class="left-image">
                    <img src="assets/images/11180.jpg" alt="" style="height: 400px; width: 400px;">
                  </div>
                </div>
                <div class="col-md-6 align-self-center">
                  <div class="right-content">
                    <h2 style="text-align: right;">أعرب رئيس مجلس ادارة جمعية الرهوة التعاونية <em> الشيخ احمد الكلي</em> عن شكره وامتنانه</h2>
                    <h1 style="text-align: right;">22/06/1442</h1>
                    <p>
                    <h4 style="text-align: right;">أعرب رئيس مجلس ادارة جمعية الرهوة التعاونية الشيخ احمد الكلي عند شكره وامتنانه لجمعية النحالين التعاونية واصحاب الايادي البيضاء من أهل الخير لدعمهم مبادرتها المجتمعية"بطاقة بذرة خير" والتي خصصت للمحتاجين وللأسر الأكثر تضررراً من جائحة كورونا وذلك بالتعاون مع</h4>
                    </p>
                  </div>
                </div>
              </div>
